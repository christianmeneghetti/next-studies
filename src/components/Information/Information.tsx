...
export function Information({ information }: DescriptionProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-zinc-900 rounded-md overflow-hidden w-[500px]">
      <div className="flex justify-center bg-zinc-700 w-full p-4 font-bold">
        {name}
      </div>
      <div className="flex justify-center p-4 text-justify h-[152px] overflow-y-auto">
        {description}
      </div>
      <div className="flex flex-wrap justify-between items-center w-full p-4 pt-0 gap-1">
